...
| **Trophy Rooms** | Cross-platform Nintendo Switch achievement & trophy tracker — a Next.js/TypeScript web app (Prisma + PostgreSQL, Clerk auth), a TypeScript GraphQL backend, and a native iOS app (Swift). | [Website](https://trophy-rooms-web.vercel.app) · [App Store](https://apps.apple.com/us/app/trophy-rooms/id6799829599) · [Web repo](https://github.com/G3mha/trophy-rooms-web) · [Backend repo](https://github.com/G3mha/trophy-rooms-backend) |
