...
![Core Data](https://img.shields.io/badge/Core_Data-1575F9?style=for-the-badge&logo=apple&logoColor=white)
...
| --- | --- | --- |
| **OpenGiving** | Hybrid personal-fundraising + marketplace platform I founded — FastAPI/Prisma backend, Next.js frontend, and Stripe Connect escrow, on AWS (ECS Fargate, RDS, CloudFront) provisioned with Terraform. | [Website](https://opengiving.me) |
| **Trophy Rooms** | Cross-platform Nintendo Switch achievement & trophy tracker — a Next.js/TypeScript web app (Prisma + PostgreSQL, Clerk auth), a TypeScript GraphQL backend, and a native iOS app (Swift). | [Live app](https://trophy-rooms-web.vercel.app) · [Web repo](https://github.com/G3mha/trophy-rooms-web) · [Backend repo](https://github.com/G3mha/trophy-rooms-backend) |
...
| **PacBag** | iOS travel-packing app (Swift/SwiftUI) — create digital twins of your luggage and track items across multiple bags so you never forget essentials. | [Website](https://pacbag.vercel.app) |
...
| **Genetic Programming** | Advanced Algorithms final project — evolving programs to fit target functions via genetic programming, in Python/Jupyter. | [Repo](https://github.com/G3mha/genetic-programming) |
